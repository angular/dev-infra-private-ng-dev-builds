...
type UnionToIntersection<U> = (U extends unknown ? (union: U) => void : never) extends (intersection: infer I) => void ? I : never;
...
export type Assertions<A extends readonly AssertionFn<unknown>[]> = UnionToIntersection<ExtractValuesAsUnionFromObject<AllAssertedTypes<A>>>;
